      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 10,),
            Text(widget.model.longDescription, style: const TextStyle(fontSize: 17, fontWeight: FontWeight.normal),textAlign: TextAlign.justify,),
            const SizedBox(height: 10,),
      ...
      builder: (c) {
        return AlertDialog(
          ...
          actions: [
            ...
            TextButton(
              onPressed: () {
                FirebaseFirestore.instance.collection('sellers').doc(sharedPreferences!.getString('uid')).collection('brands').doc(widget.model.brandID).collection('items').doc(widget.model.itemID).delete().then((value) {
                  FirebaseFirestore.instance.collection('items').doc(widget.model.itemID).delete().then((value) {
                    Fluttertoast.showToast(msg: "Item ${widget.model.itemTitle} deleted Successfully", gravity: ToastGravity.CENTER);
